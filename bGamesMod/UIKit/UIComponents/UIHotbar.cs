		...
		internal bool selected
		{
			...
			set
			{
				...
				else
				{
					...
					Visible = true;
					//HotBarParent
					if (bGamesMod.ServiceHotbar.HotBarChild != null && bGamesMod.ServiceHotbar.HotBarChild != this)
					{
						bGamesMod.ServiceHotbar.HotBarChild.selected = false;
					}
					this.CenterXAxisToParentCenter();
					bGamesMod.ServiceHotbar.HotBarChild = this;
				}
				arrived = false;
				_selected = value;
			}
